      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-6 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-muted leading-relaxed mb-6 max-w-xs">
              The fully autonomous, open-source AI marketing operating system.
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg glass flex items-center justify-center text-muted hover:text-text hover:border-border-light transition-all"
                >
                  {social.icon}
                </a>
              ))}
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h4 className="text-sm font-semibold mb-4 text-text">
                {category}
              </h4>
        ...
        <div className="mt-14 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-dark">
            © {new Date().getFullYear()} CreatorOS AI. Open source under MIT License.
          </p>
