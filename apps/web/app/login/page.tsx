...
const socialProviders = [
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        <path d="M15.174 18.005c-1.393.914-3.328 1.488-5.358 1.488-4.707 0-8.918-2.327-11.66-6.071-.341-.465.176-.948.643-.594 3.179 2.41 7.202 3.799 11.455 3.799 1.83 0 3.593-.277 5.253-.789.605-.187 1.059.458.621.921a22.583 22.583 0 01-.954.246zm3.504-2.733c-.702-1.299-3.415-1.189-4.721-.994-.359.054-.424-.447-.091-.655 2.115-1.319 5.378-1.07 6.305.514.939 1.603.023 5.093-1.892 6.892-.26.244-.68-.029-.545-.371.492-1.25.152-3.134-1.056-5.386z" />
      </svg>
    ),
  },
  {
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12">
        ...
        >
          ...
          <h1 className="text-4xl font-bold leading-tight mb-4">
            ...
            <span className="gradient-text">creative command center</span>
          </h1>

          <p className="text-muted leading-relaxed mb-10">
            Log in to access your AI-powered content agency. Create, publish,
            and optimize — all from one place.
          </p>

          <div className="space-y-4">
            {[
              { icon: "⚡", text: "AI-powered content creation" },
              { icon: "🎨", text: "Image & video synthesis" },
                ...
                <button
                  ...
                  onClick={() => {
                    if (provider.id === 'phone') {
                      ...
                      setError("Telegram login is not yet supported natively. Please use another method.");
                    } else {
